...
fn test_user_registration()
    var inputs := [
        unicode "John",           // name
        unicode "john@email.com", // email
        unicode "password123"     // password
    ]
    ...
    assert(email = unicode "john@email.com")
    assert(password = unicode "password123")
end fn
...
fn test_file_workflow()
    ...
    assert(processed[0] = unicode "LINE 1")
    assert(processed[1] = unicode "LINE 2")
    assert(processed[2] = unicode "LINE 3")
